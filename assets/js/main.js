...
function plusSlides3(x) {
	showSlides3(slideIndex3 += x);
  }
...
function showSlides2(x) {
  ...
  if (x > slides.length) {slideIndex2 = 1}
  if (x < 1) {slideIndex2 = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  }
...
function showSlides4(x) {
	...
	if (x > slides.length) {slideIndex4 = 1}
	if (x < 1) {slideIndex4 = slides.length}
	for (i = 0; i < slides.length; i++) {
		slides[i].style.display = "none";
	}
